...
class App {
    ...
    setupRoutes() {
        try {
            ...
            const routeConfig = (0, routes_manager_1.getDefaultRouteConfig)(this.authService, this.asaciManager);
    ...
    async getHealthStatus() {
        ...
        const overallStatus = Object.values(services).every(service => service.status === 'healthy' || service.status === 'ok') ? 'healthy' : 'degraded';
        return {
