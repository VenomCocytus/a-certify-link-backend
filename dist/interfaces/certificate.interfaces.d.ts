...
export type CertificateStatus = 'pending' | 'processing' | 'completed' | 'failed' | 'cancelled' | 'suspended';
export type CertificateAction = 'created' | 'updated' | 'cancelled' | 'suspended' | 'downloaded' | 'status_checked';
...
export interface BulkCertificateResult {
    ...
    results: Array<{
        ...
        result: CertificateCreationResult | {
            error: string;
        };
    }>;
    processingTime: number;
}
//# sourceMappingURL=certificate.interfaces.d.ts.map