...
import { CertificateCreationResult, CertificateOperationRequest, CertificateOperationResult, CertificateData, CertificateSearchCriteria, BulkCertificateRequest, BulkCertificateResult } from './certificate.interfaces';
...
export interface HealthServiceInterface {
    ...
    checkOrassHealth(): Promise<{
        status: 'healthy' | 'unhealthy';
        responseTime?: number;
        error?: string;
    }>;
    checkIvoryAttestationHealth(): Promise<{
        status: 'healthy' | 'unhealthy';
        responseTime?: number;
        error?: string;
    }>;
