...
exports.requireRoles = exports.requirePermissions = exports.authMiddleware = void 0;
...
const requirePermissions = (requiredPermissions) => {
    return (req, res, next) => {
        ...
        const hasRequiredPermissions = requiredPermissions.every(permission => userPermissions.includes(permission) || req.user.role === 'admin');
