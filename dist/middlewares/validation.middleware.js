...
exports.validateQuery = exports.validateDto = exports.validateJoi = void 0;
    ...
    return async (req, res, next) => {
        try {
            ...
            if (errors.length > 0) {
                ...
                const validationException = new validation_exception_1.ValidationException('Validation failed', { validationErrors }, req.originalUrl);
                next(validationException);
                return;
            }
